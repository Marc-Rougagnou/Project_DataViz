...
st.write("I chose this database because, having taken this exam, I wanted to see what the results had been for the whole of France, and how they had evolved between the different types of baccalaureate.\n\nI got the 'assez-bien' mention in 2021, my year was a bit special as it took place during the COVID-19 pandemic. What's more, the database mainly contains data from 2021, which means I can find myself in the database")
...
st.markdown("<h5 style='color: DarkOrange;'>Missing data?</h5>", unsafe_allow_html=True)
...
st.markdown("<h5 style='color: DarkOrange;'>Duplicate lines?</h5>", unsafe_allow_html=True)
...
st.write("As you can see, the majority of students take the general baccalaureate, as this is the route that currently closes the fewest doors to students.")
